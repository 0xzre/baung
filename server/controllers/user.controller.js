...
const MESSAGE = {
  ...
  INCORRECT_EMAIL: "Incorrect email/username",
...
const signin = async (req, res, next) => {
  ...
  try {
    ...
    const existingUser = existingUserWithEmail ? existingUserWithEmail : existingUserWithName;
 ...
 *
 * @description If the email domain of the user's email is "mod.baung.com", the user will be
...
const addUser = async (req, res, next) => {
  ...
  const role = emailDomain === "mod.baung.com" ? "moderator" : "general";
