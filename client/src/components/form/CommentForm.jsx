  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="my-4">
          <textarea
            className="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-green-500 resize-none"
            name="content"
            value={content}
        ...
        <div className="flex justify-end">
          <button
            className="px-4 py-2 text-sm font-medium text-white bg-primary rounded-md hover:bg-green-600 focus:outline-none focus:bg-green-600"
            type="submit"
            disabled={isLoading}
            style={{
