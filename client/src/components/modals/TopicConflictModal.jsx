  ...
  >
    ...
    <div className="bg-white rounded-lg shadow-lg p-8 w-full md:w-96 relative z-10">
      <div className="text-center">
        ...
        <button
          className="bg-primary text-sm hover:bg-green-700 text-white font-semibold py-2 px-6 rounded focus:outline-none focus:shadow-outline transition-colors duration-300"
          onClick={handleClose}
        >
          Got it, thanks!
        </button>
