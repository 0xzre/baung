    ...
    <div>
      <div className="relative">
        <input
          ...
          className="h-10 py-1 bg-white border w-full md:w-[660px] rounded-full text-sm shadow-sm focus:outline-none focus:shadow-outline-green focus:border-green-500 transition duration-300 pl-3 pr-10"
          aria-label="Search"
          autoComplete="off"
        />
        {inputValue !== "" && (
              ...
              {posts.map((post) => (
                <li key={post._id} className="border-b py-2 px-4">
                  <div
                    ...
                    className="block text-sm text-gray-700 hover:text-green-500 cursor-pointer"
                  >
