            ...
            {visibleCommunities?.map((community) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-primary border border-dashed border-green-500
                        hover:bg-primary 
          ...
          recommendedUsers.map((user) => (
            ...
            >
              ...
              <button
                ...
                className="text-primary border border-dashed border-green-500 hover:bg-primary rounded-md py-1 px-2 text-sm font-semibold group transition duration-300"
              >
